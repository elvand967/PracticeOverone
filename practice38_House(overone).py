# Практическое задание №38 House (overone)
...
# Сделка состоялась!!! Поздравляем с приобретением новой недвижимости: <__main__.SmallHouse object at 0x000001E26B6FF370>
# !!!Еше раз поинтересуемся положением дел у Alex:
# Name: Alex
# Age: 25
# Money: 6000.0
# House: <__main__.SmallHouse object at 0x000001E26B6FF370>